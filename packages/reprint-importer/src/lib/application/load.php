...
require_once __DIR__ . '/use-case/class-db-domains-handler.php';
require_once __DIR__ . '/use-case/class-files-pull-handler.php';
require_once __DIR__ . '/use-case/class-files-index-handler.php';
require_once __DIR__ . '/use-case/class-db-pull-handler.php';
require_once __DIR__ . '/use-case/class-db-index-handler.php';
require_once __DIR__ . '/use-case/class-db-apply-handler.php';
require_once __DIR__ . '/use-case/class-flat-docroot-handler.php';
